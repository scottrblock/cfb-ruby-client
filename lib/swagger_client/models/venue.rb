...
module SwaggerClient
  class Venue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'grass')
        self.grass = attributes[:'grass']
      end
      ...
      if attributes.has_key?(:'dome')
        self.dome = attributes[:'dome']
      end
    end
    ...
    def hash
      [id, name, capacity, grass, city, state, zip, country_code, location, elevation, year, dome].hash
    end
