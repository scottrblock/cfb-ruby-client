...
module SwaggerClient
  class TeamMatchupGames
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'neutralSite')
        self.neutral_site = attributes[:'neutralSite']
      end
      ...
      if attributes.has_key?(:'homeTeam')
        self.home_team = attributes[:'homeTeam']
      end
      ...
      if attributes.has_key?(:'awayTeam')
        self.away_team = attributes[:'awayTeam']
      end
    ...
    def hash
      [season, week, season_type, date, neutral_site, venue, home_team, home_score, away_team, away_score, winner].hash
    end
