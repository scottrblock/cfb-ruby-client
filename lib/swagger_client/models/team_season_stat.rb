...
module SwaggerClient
  class TeamSeasonStat
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'statName')
        self.stat_name = attributes[:'statName']
      end

      if attributes.has_key?(:'statValue')
        self.stat_value = attributes[:'statValue']
      end
    end
    ...
    def hash
      [season, team, conference, stat_name, stat_value].hash
    end
