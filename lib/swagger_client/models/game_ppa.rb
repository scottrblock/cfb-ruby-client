...
module SwaggerClient
  class GamePPA
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'opponnent')
        self.opponnent = attributes[:'opponnent']
      end
    ...
    def hash
      [id, season, week, team, conference, opponnent, offense, defense].hash
    end
