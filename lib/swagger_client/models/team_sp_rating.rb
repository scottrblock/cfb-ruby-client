...
module SwaggerClient
  class TeamSPRating
    ...
    attr_accessor :second_order_wins
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'secondOrderWins')
        self.second_order_wins = attributes[:'secondOrderWins']
      end

      if attributes.has_key?(:'sos')
      ...
      if attributes.has_key?(:'specialTeams')
        self.special_teams = attributes[:'specialTeams']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rating == o.rating &&
          second_order_wins == o.second_order_wins &&
          sos == o.sos &&
          offense == o.offense &&
          defense == o.defense &&
          special_teams == o.special_teams
    end
    ...
    def hash
      [year, team, conference, rating, second_order_wins, sos, offense, defense, special_teams].hash
    end
