...
module SwaggerClient
  class RankingWeekRanks
    ...
    attr_accessor :first_place_votes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'firstPlaceVotes')
        self.first_place_votes = attributes[:'firstPlaceVotes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          first_place_votes == o.first_place_votes &&
          points == o.points
    end
    ...
    def hash
      [rank, school, conference, first_place_votes, points].hash
    end
